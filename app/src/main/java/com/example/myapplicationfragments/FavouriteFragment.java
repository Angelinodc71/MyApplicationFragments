...
public class FavouriteFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        noticiasAdapter = new FavouriteFragment.NoticiasAdapter();
    ...
    class NoticiasAdapter extends  RecyclerView.Adapter<FavouriteFragment.NoticiasAdapter.NoticiaViewHolder> {
        private List<NoticiaEverything> noticiasArriba = null;

        @NonNull
        @Override
        public FavouriteFragment.NoticiasAdapter.NoticiaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new FavouriteFragment.NoticiasAdapter.NoticiaViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_noticia, parent, false));
        }

        @Override
        public void onBindViewHolder(@NonNull FavouriteFragment.NoticiasAdapter.NoticiaViewHolder holder, int position) {
